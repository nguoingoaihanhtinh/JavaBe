        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-3">
                    ...
                    <React.Fragment>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/admin" || pathname.includes("dashboard")) && "bg-graydark dark:bg-meta-4"
                        }`}
                      >
              ...
              {/* <!-- Menu Item Tables --> */}
              {/* <!-- Menu Item Forms --> */}
              <SidebarLinkGroup activeCondition={pathname === "/admin/food" || pathname.includes("forms")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/admin/food" || pathname === "/admin/type") && "bg-graydark dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      {/* <!-- Dropdown Menu Start --> */}
                      <div className={`translate transform overflow-hidden -mt-2 ${!open && "hidden"}`}>
